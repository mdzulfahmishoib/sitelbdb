...
return new class extends Migration
{
    ...
    {
        Schema::create('pelaporan_bpjs', function (Blueprint $table) {
            $table->id('id_pelaporan_bpjs'); // This will create an auto-incrementing unsigned integer primary key.
    ...
    {
        Schema::dropIfExists('pelaporan_bpjs');
    }
};
