        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="pelaporan_dirjen_pajak-form" action="{{ route('pelaporan_dirjen_pajak.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
...
<script>
    document.getElementById('jenis_periode').addEventListener('change', function () {
        ...
        const options = {
            Bulanan: [
                { value: 'Pelaporan ke DJP PPh 23', text: 'Pelaporan ke DJP PPh 23' },
                { value: 'Pelaporan Pajak PPh 21 Karyawan', text: 'Pelaporan Pajak PPh 21 Karyawan' },
                { value: 'Pelaporan Pajak PPH Pasal 25', text: 'Pelaporan Pajak PPH Pasal 25' },
                { value: 'Pelaporan Pajak PPH Pasal 4 ayat 2', text: 'Pelaporan Pajak PPH Pasal 4 ayat 2' },
                { value: 'Pembayaran Pajak PPH Pasal 25', text: 'Pembayaran Pajak PPH Pasal 25' },
                { value: 'Pembayaran PPh 21 (Gaji) - Jenis Masa', text: 'Pembayaran PPh 21 (Gaji) - Jenis Masa' },
                { value: 'Pembayaran PPh 23 (Masa) - Jenis Masa', text: 'Pembayaran PPh 23 (Masa) - Jenis Masa' },
                { value: 'Pembayaran PPh 4 ayat 2 (Bunga / Bagi Hasil Simpanan) - Jenis Final', text: 'Pembayaran PPh 4 ayat 2 (Bunga / Bagi Hasil Simpanan) - Jenis Final' },
            ],
            Tahun: [
                { value: 'Laporan Pajak Tahunan Perusahaan', text: 'Laporan Pajak Tahunan Perusahaan' },
            ],
        };
