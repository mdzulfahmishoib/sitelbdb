        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="pelaporan_lps-form" action="{{ route('pelaporan_lps.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
...
<script>
    document.getElementById('jenis_periode').addEventListener('change', function () {
        ...
        const options = {
            Semester: [
                { value: 'Laporan Pembayaran Premi', text: 'Laporan Pembayaran Premi' },
            ],
            Tahun: [
                { value: 'Laporan Tahunan (Audited)', text: 'Laporan Tahunan (Audited)' },
            ],
        };
