        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="collapse mb-4 bg-light" id="collapseIsidentil">
                                <div class="card-body border">
                                    <div id="nama_laporan_isidentil" class="form-group mb-3">
                                    ...
                                    <div id="instansi_dilaporkan" class="form-group">
                                        <label for="instansi_dilaporkan">Instansi yang dilaporkan</label>
                                        <input type="text" name="instansi_dilaporkan" id="instansi_dilaporkan" class="form-control" placeholder="Masukkan nama instansi">
                                    </div>      
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <form id="pelaporan_pemkab-form" action="{{ route('pelaporan_pemkab.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
...
<script>
    document.getElementById('jenis_periode').addEventListener('change', function () {
        ...
        const options = {
            Triwulan: [
            { value: 'Laporan Triwulan ke Pemkab', text: 'Laporan Triwulan ke Pemkab' }
            ],
            Tahun: [
            { value: 'Laporan Rencana Bisnis Bank (RBB) dan RKA', text: 'Laporan Rencana Bisnis Bank (RBB) dan RKA' },
            { value: 'Laporan Pelaksanaan Tata Kelola (Good Corporate Governance)', text: 'Laporan Pelaksanaan Tata Kelola (Good Corporate Governance)' }
            ],
        };
