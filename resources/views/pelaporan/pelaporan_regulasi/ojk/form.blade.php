        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="pelaporan_ojk-form" action="{{ route('pelaporan_ojk.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
...
<script>
    document.getElementById('jenis_periode').addEventListener('change', function () {
        ...
        const options = {
            Bulanan: [
            { value: 'Laporan Bulanan', text: 'Laporan Bulanan' },
            { value: 'Laporan SLIK', text: 'Laporan SLIK' },
            { value: 'Koreksi Laporan Bulanan', text: 'Koreksi Laporan Bulanan' },
            { value: 'Koreksi Laporan SLIK', text: 'Koreksi Laporan SLIK' },
            ],
            Triwulan: [
            { value: 'Laporan Keuangan Publikasi Triwulan (BUKTI)', text: 'Laporan Keuangan Publikasi Triwulan (BUKTI)' },
            { value: 'Laporan Penyelesaian Pengaduan Nasabah Triwulan', text: 'Laporan Penyelesaian Pengaduan Nasabah Triwulan' },
            { value: 'Pembayaran Iuran OJK (SIPO)', text: 'Pembayaran Iuran OJK (SIPO)' },
            { value: 'Laporan Keuangan Publikasi Triwulan INFO', text: 'Laporan Keuangan Publikasi Triwulan INFO' },
            ],
            Semester: [
            { value: 'Laporan Pelaksanaan dan Pengawasan Rencana Bisnis Bank (RBB)', text: 'Laporan Pelaksanaan dan Pengawasan Rencana Bisnis Bank (RBB)' },
            { value: 'Laporan Realisasi Literasi, Inkluasi dan Edukasi', text: 'Laporan Realisasi Literasi, Inkluasi dan Edukasi' },
            { value: 'Laporan TKS (Profil Risiko Semester II dan Tata Kelola)', text: 'Laporan TKS (Profil Risiko Semester II dan Tata Kelola)' },
            ],
            Tahun: [
            { value: 'Lap. Self Assessment Edukasi dan Perlindungan Konsumen', text: 'Lap. Self Assessment Edukasi dan Perlindungan Konsumen' },
            { value: 'Lap. Hasil Evaluasi komite Audit terhadap pelaksanaan pemberian jasa audit atas informasi keuangan historis tahunan oleh AP dan/atau KAP', text: 'Lap. Hasil Evaluasi komite Audit terhadap pelaksanaan pemberian jasa audit atas informasi keuangan historis tahunan oleh AP dan/atau KAP' },
            ],
        };
