            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select id="jenis_bpjs" class="form-control" name="jenis_bpjs">
                            ...
                            <div id="nama_laporan" class="form-group mb-4">
                                ...
                                <select id="nama_laporan" name="nama_laporan" class="form-control">
                                    ...
                                    <option value="Iuran BPJS Kesehatan">Iuran BPJS Kesehatan</option>
                                    <option value="Iuran BPJS Ketenagakerjaan">Iuran BPJS Ketenagakerjaan</option>
                                </select>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <form id="pelaporan_bpjs-form" action="{{ route('pelaporan_bpjs.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
