        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="pelaporan_ppatk-form" action="{{ route('pelaporan_ppatk.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields -->
...
<script>
    document.getElementById('jenis_periode').addEventListener('change', function () {
        ...
        const options = {
            Triwulan: [
                { value: 'Laporan Sipesat Triwulan I', text: 'Laporan Sipesat Triwulan I' },
                { value: 'Laporan Sipesat Triwulan II', text: 'Laporan Sipesat Triwulan II' },
                { value: 'Laporan Sipesat Triwulan III', text: 'Laporan Sipesat Triwulan III' },
                { value: 'Laporan Sipesat Triwulan IV', text: 'Laporan Sipesat Triwulan IV' },
            ],
        };
